...
# Vendored change: upstream imports these unguarded, so the module could not be
# imported at all without flash-attn. Only the Flash* classes below need them;
# MultiHeadSelfAttention uses dot_product_attention and works without.
try:
    ...
    flash_attn_varlen_qkvpacked_func = flash_attn_qkvpacked_func = None
